...
export function combatState(w:World,b:Body,decidedAtMs?:number) {
  ...
  return {id:a.id,commandId:a.commandId,actorBodyId:b.id,kind:a.kind,definition:a.definition,
    trajectory:a.trajectory,variant:a.variant,moveId:a.moveId,repertoireRevision:a.repertoireRevision,startedAt:a.startedAt,activeAt:a.activeAt,recoveryAt:a.recoveryAt,completeAt:a.completeAt,

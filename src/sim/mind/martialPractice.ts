...
export function submitTechniqueUse(world: World, p: Person, eventId: string): number {
  ...
  // A performed learned transition also practices the edge itself, at reduced weight and
  // without double-crediting family proficiency (already credited for the destination above).

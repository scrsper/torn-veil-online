...
export function makeBody(world: World, ownerId: EntityId, pos: Vec3, shape: Body['shape'] = 'humanoid', maxHealth = 80): Body {
  const b: Body = {
    ...
    path: null, pathIndex: 0, pathGoal: null, speed: 3.4, health: maxHealth, maxHealth, dead: false, lastHitAt: -99, lastAttackAt: -99, attackSeq: 0, hitSeq: 0, attackTarget: null, subduedUntil: 0, sitAnchor: null, present: true,
  };

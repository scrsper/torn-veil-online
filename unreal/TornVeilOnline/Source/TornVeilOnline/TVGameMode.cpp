...
void ATVHUD::DrawHUD() {
    ...
    DrawText(TEXT("WASD move | Shift sprint | Mouse look | E interact | I inventory | J journal | Esc menu | F6 inspector"), FLinearColor(0.7f, 0.75f, 0.8f), 36, 90);
    if(B->bArena) {
        DrawText(TEXT("LMB light | Mouse4 heavy | RMB guard | Alt dodge | F lock | F1 passive | F2 incoming | F3 reset"),FLinearColor(1,.85f,.5f),36,112);

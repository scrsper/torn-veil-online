...
void ATVHUD::DrawHUD() {
    ...
    if (auto* T = B->Selected()) {
        DrawRect(FLinearColor(0.02, 0.02, 0.03, 0.9), 20, 140, 470, B->bInspector ? 270 : (T->RecognisedClass.IsEmpty() ? 90 : 115));
        // Occupation is what this person does for a living. A recognised class is what their
        ...
        if (!T->ClassEvidence.IsEmpty()) DrawText(T->ClassEvidence.Left(96), FLinearColor(0.65, 0.7, 0.78), 36, 200);
